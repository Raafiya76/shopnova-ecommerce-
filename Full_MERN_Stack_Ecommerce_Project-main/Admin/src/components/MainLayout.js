...
const MainLayout = () => {
  ...
  const { adminProfile, user } = useSelector((state) => state.auth);
      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        <div className="logo">
          <h2 className="text-white fs-5 text-center py-3 mb-0">
            ...
            <span className="lg-logo">ShopNova</span>
          </h2>
        </div>
        <Menu
          theme="dark"
        ...
        >
          ...
          <div className="d-flex gap-4 align-items-center">
            <div className="d-flex gap-3 align-items-center dropdown">
              <div
                className="d-flex align-items-center justify-content-center rounded-circle bg-secondary text-white fw-bold"
              ...
              <div
                ...
                aria-expanded="false"
              >
                <h5 className="mb-0">{adminName}</h5>
